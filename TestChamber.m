...
%SNR_list = [-30:2:-18, -17.7:0.5:0, 1:5, 6:2:30, 35:5:160];
...
% [allerr_list2, SNRs_list2, type_name2, corr_osval2] = getErrsToSnrs(distance, sig_time, SNR_list, os_type, 5, co_value, lin_cub, iters);
% [allerr_list3, SNRs_list3, type_name3, corr_osval3] = getErrsToSnrs(11.72, sig_time, SNR_list, os_type, os_value, co_value, lin_cub, iters);
% [allerr_list4, SNRs_list4, type_name4, corr_osval4] = getErrsToSnrs(11.72, sig_time, SNR_list, os_type, 5, co_value, lin_cub, iters);
...
% hold on;
% p2 = plot(SNRs_list, allerr_list2(2, :)*10^(9), 'Color', [0.8500 0.3250 0.0980], 'LineWidth', 1.5); %żółty 
...
% figure('Name', 'Deviation: 0m vs 11,72m' )
% p1 = plot(SNRs_list, allerr_list(2, :)*10^(9), 'Color', [0 0.4470 0.7410], 'LineWidth', 1.5); 
% hold on;
...
% ylabel('Odchylenie standardowe [ns]')
% axis([-23 20 -3 70])
% legend([p1, p2, p3, p4], {'Brak nadpróbkowania', 'Nadpróbkowanie = 5', 'Brak nadpróbkowania', 'Nadpróbkowanie = 5'}, 'Location', 'best')
% grid on
% 
% figure('Name', 'RMS: 0m vs 11,72m' )
% p1 = plot(SNRs_list, allerr_list(3, :)*10^(9), 'Color', [0 0.4470 0.7410], 'LineWidth', 1.5); 
% hold on;
