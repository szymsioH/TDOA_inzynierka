...
[allerr_list, SNRs_list, type_name, corr_osval] = getErrsToSnrs(distance, SNR_list, os_type, os_value, 20, iters);
% [allerr_list2, SNRs_list2, type_name2, corr_osval2] = getErrsToSnrs(distance, SNR_list, os_type, 5, co_value, iters);
% [allerr_list3, SNRs_list3, type_name3, corr_osval3] = getErrsToSnrs(distance, SNR_list, os_type, 10, co_value, iters);
% [allerr_list4, SNRs_list4, type_name4, corr_osval4] = getErrsToSnrs(distance, SNR_list, os_type, 20, co_value, iters);
