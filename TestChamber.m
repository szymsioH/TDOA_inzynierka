...
distance = 0; %odległość w m
os_type = 3; %rodzaj interpolacji/nadpróbkowania sygnału
os_value = 1;
co_value = 1;
...
[allerr_list, SNRs_list, type_name, corr_osval] = getErrsToSnrs(distance, SNR_list, os_type, os_value, co_value, lin_cub, iters);
[allerr_list2, SNRs_list2, type_name2, corr_osval2] = getErrsToSnrs(distance, SNR_list, os_type, 5, co_value, lin_cub, iters);
[allerr_list3, SNRs_list3, type_name3, corr_osval3] = getErrsToSnrs(distance, SNR_list, os_type, 10, co_value, lin_cub, iters);
[allerr_list4, SNRs_list4, type_name4, corr_osval4] = getErrsToSnrs(distance, SNR_list, os_type, 20, co_value, lin_cub, iters);
[allerr_list5, SNRs_list5, type_name5, corr_osval5] = getErrsToSnrs(distance, SNR_list, os_type, 50, co_value, lin_cub, iters);
...
% ylabel('Odchylenie standardowe [ns]')
% axis([-23 20 -3 50])
% legend([p1, p2, p3, p4], {'1, 11,71m', '5, 11,71m', '1, 1000m', '5, 1000m'}, 'Location', 'best')
% grid on
% 
